...
{
	/// <summary>
	/// 数据库操作类 ，数据库表名：MeetingComment 
	/// </summary>
	public partial class MeetingCommentMap : ManageSystemEntityTypeConfiguration<MeetingComment>
	{

		public MeetingCommentMap()
		{
			this.ToTable("MeetingComment");
			this.HasKey(p => p.Id);
