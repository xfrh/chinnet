...
{
	/// <summary>
	/// 数据库操作类 ，数据库表名：MedicalOrganism 
	/// </summary>
	public partial class MedicalOrganismMap : ManageSystemEntityTypeConfiguration<MedicalOrganism>
	{

		public MedicalOrganismMap()
		{
			this.ToTable("MedicalOrganism");
			this.HasKey(p => p.Id);
            ...
            this.Property(p => p.GroupName).HasMaxLength(1000);
