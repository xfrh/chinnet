...
{
    /// <summary>
    /// 数据库操作类 ，数据库表名：MedicalOrganismTypeMap 
    /// </summary>
    public partial class MedicalOrganismTypeMap : ManageSystemEntityTypeConfiguration<MedicalOrganismType>
	{

		public MedicalOrganismTypeMap()
		{
			this.ToTable("MedicalOrganismType");
			this.HasKey(p => p.Id);
