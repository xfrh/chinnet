...
namespace ManageSystem.Services.SystemSet
{
	...
	/// 操作类 ，数据库表名：UserRole 
	/// </summary>
	public partial class SatelliteMenuRoleService :  BaseService<SatelliteMenuRole>, ISatelliteMenuRoleService
    {

        private readonly IRepository<SatelliteMenuRole> satelliteMenuRoleRepository;

        public SatelliteMenuRoleService(IRepository<SatelliteMenuRole> repository, IRepository<SatelliteMenuRole> _satelliteMenuRoleRepository): base(repository)
		{

            this.satelliteMenuRoleRepository = _satelliteMenuRoleRepository;
    }

        public void getBySatelliteUserId(SatelliteMenuRole role, string roleIds)
        {
        ...
        public void Insert(SatelliteUser user, string roleIds)
        {
            ...
            {
                var entity = new SatelliteMenuRole()
                {
                    SatelliteMenuId = long.Parse(item),
