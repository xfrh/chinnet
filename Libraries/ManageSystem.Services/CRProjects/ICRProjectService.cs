...
namespace ManageSystem.Services.CRProjects
{
    ...
    /// </summary>
    public partial interface ICRProjectService : IBaseService<CRProject>
    {
        ...
        /// <returns></returns>
        IPagedList<CRProject> QueryPage(string hospitalName, long hospitalId, int pageIndex = 0, int pageSize = int.MaxValue);
        ...
        /// <returns></returns>
        string Download(IEnumerable<long> ids, CRProjectDownloadEnum downloadEnum);
        ...
        /// <returns></returns>
        IQueryable<CRProject> Query(long memberId);
        ...
        string Upload(long id, string filePath, string oldFileName, Member member);
        ...
        /// <returns></returns>
        CRProject QueryEntityByMember(long memberId);
        ...
        /// <param name="member">当前登录用户</param>
        /// <returns>SUCCESS 表示成功，其他则是错误信息</returns>
        string Update(CRProject entity, Member member);
