...
namespace ManageSystem.Services.Media
{
    ...
    public partial class PictureService : IPictureService
    {
        ...
        protected virtual void DeletePictureThumbs(Picture picture)
        {
            ...
            var thumbDirectoryPath = _webHelper.MapPath("~/content/upload/images/thumbs");
        ...
        {
            var thumbsDirectoryPath = _webHelper.MapPath("~/content/upload/images/thumbs");
        ...
        protected virtual string GetThumbUrl(string thumbFileName, string storeLocation = null)
        {
            ...
            var url = storeLocation + "content/upload/images/thumbs/";
        ...
        /// <summary>
        /// 得到图像局部路径。时使用的图像存储在文件系统(而不是数据库)
        /// </summary>
        /// <param name="fileName">Filename</param>
        /// <param name="imagesDirectoryPath">与图片目录路径;如果null,那么默认使用一个</param>
        ...
        protected virtual string GetPictureLocalPath(string fileName, string imagesDirectoryPath = null)
        {
            ...
            {
                imagesDirectoryPath = _webHelper.MapPath("~/content/upload/images/");
            }
        ...
        /// </summary>
        /// <param name="picture">Picture</param>
        /// <param name="fromDb">从数据库加载;否则,从文件系统</param>
        /// <returns>Picture binary</returns>
            ...
            string storeLocation = null)
        {
            ...
            if (targetSize == 0)
            {
                string url = (!String.IsNullOrEmpty(storeLocation)
                                 ? storeLocation
                                 : _webHelper.GetStoreLocation())
                                 + "content/upload/images/" + defaultImageFileName;
                return url;
            }
            else
            {
        ...
        public virtual Picture GetPictureById(long pictureId)
        {
            if (pictureId == 0)
                return null;
        ...
        /// <param name="validateBinary">A value indicating whether to validated provided picture binary</param>
        /// <returns>Picture</returns>
        public virtual Picture UpdatePicture(long pictureId, byte[] pictureBinary, string mimeType,
        ...
        /// <param name="seoFilename">The SEO filename</param>
        /// <returns>Picture</returns>
        public virtual Picture SetSeoFilename(long pictureId, string seoFilename)
        {
            var picture = GetPictureById(pictureId);
            if (picture == null)
