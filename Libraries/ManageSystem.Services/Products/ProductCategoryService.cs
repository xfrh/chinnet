...
namespace ManageSystem.Services.Products
{
    ...
    public partial class ProductCategoryService : BaseService<ProductCategory>, IProductCategoryService
    {
        ...
        public IPagedList<ProductCategory> QueryPage(string name, string state, int pageIndex = 0, int pageSize = int.MaxValue)
        {
            ...
            var list = new PagedList<ProductCategory>(query.ToList(), pageIndex, pageSize);
