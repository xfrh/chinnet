...
namespace ManageSystem.Core.Domain.CRs
{
    ...
    /// 对应数据库CRData表
    /// </summary>
    public partial class CRData: BaseEntity
    {
        /// <summary>
        /// 会员Id
        /// <summary>
    ...
    public class UploadProjectResult
    {
        ...
        /// 上传数据对象
        /// </summary>
        public CRData MedicalEntity { get; set; }
        ...
        /// 验证信息
        /// </summary>
        public List<CRItemValidate> ValidateList { get; set; }
        ...
        /// 读取Excel中Item数据集合
        /// </summary>
        public List<CRItem> ExcelItemList { get; set; }

        /// <summary>
        /// 需要保存到数据库的中Item数据集合
        /// </summary>
        public List<CRItem> ItemList { get; set; }

        /// <summary>
        /// 医学数据 细菌（基础数据）
        /// </summary>
        public List<CRItem> OrganismList { get; set; }

        /// <summary>
        /// 医学数据 抗生素（基础数据）
        /// </summary>
        public List<CRItem> AntibioticList { get; set; }
