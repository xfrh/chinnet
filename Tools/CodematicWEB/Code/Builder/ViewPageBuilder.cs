...
{
    public class ViewPageBuilder : BuilderBase
    {
        ...
        public ViewPageBuilder(TableInfoModel _tableinfo) : base(_tableinfo)
        {
        ...
        public override void CreateCode()
        {
            ...
            string filePath = fileFloder +"\\"+ base.Tableinfo.EntityClassName + "View.cshtml"; //文件完整路径
            if (File.Exists(filePath)) File.Delete(filePath);


            //模版文件地址
            string tempPath = HttpContext.Current.Server.MapPath("~/File/Template/Test002/View.cshtml.t");
            //替换内容
            string htmlString = "";
            ...
            htmlString = htmlString.Replace("<$$TableTitle$$>", "查看"+base.Tableinfo.ShowName);
