...
namespace CodematicWEB.Common
{
   public class DateUtil
   {
      ...
      */
      ...
      {
          if (!ValidateUtil.IsDateTime(dtfrm.ToString()) || !ValidateUtil.IsDateTime(dtto.ToString()))
          {
              return -1;
          }
      ...
      /// <summary>
      /// 如果传入的值是合法日期，系统返回传入值否则返回传入的默认值。
      /// </summary>
      /// <param name="dateTime">输入日期字符串</param>
      /// <param name="defaultValue">默认值，为空表示当前时间</param>
      /// <returns>True/False</returns>
      public static DateTime  GetValueOrDefault(string dateTime, DateTime defaultValue)
      {

          if (!string.IsNullOrEmpty(DefalutDataTime(dateTime)) && IsData(dateTime))
          {
              return Convert.ToDateTime(dateTime);
          }
          else
          {
              return defaultValue == null ? DateTime.Now : Convert.ToDateTime(defaultValue);
          }
      }
      ...
      /// <param name="defaultValue">默认值，为空表示当前时间</param>
      /// <returns>True/False</returns>
      public static string GetValueOrDefault(string dateTime, string  defaultValue)
      {
       ...
       /// <returns></returns>
       public static bool IsData(object data)
       {
           try
           {
      ...
      /// 例如：1900-1-1 0:00:00 
      /// </summary>
      /// <param name="strDate">日期格式的字符串</param>
      /// <returns>string</returns>
      public static string DefalutDataTime(string strDate)
      {
          string strReturn = "";
          if (strDate.Equals("1900-1-1 0:00:00") ||
              strDate.Equals("0001-1-1 0:00:00") ||
              strDate.Equals("1900-1-1") || 
              strDate.Equals("0001-1-1 0:00") || 
              strDate.Equals("0001-01-01 00:00") || 
              strDate.Equals("0001-1-1 00:00:00") || 
              strDate.Equals("0001-1-1") || 
              strDate.Equals("1900-1-1 00:00:00") || 
              strDate.Equals("1900-01-01") || 
              strDate.Equals("0001-01-01") ||
              strDate.Equals("1900-01-01 00:00:00.000") ||
              strDate.Equals("1900-01-01 0:00:00") ||
              strDate.Equals("0001-01-01 0:00:00")
