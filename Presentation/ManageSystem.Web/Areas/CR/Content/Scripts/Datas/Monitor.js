$(document).ready(function () {
    // 初始化加载数据项
    $.getJSON('/Content/Scripts/Datas/Monitor.json', function (data) {
    ...
    // 初始化加载数据项  抗菌药物
    $.getJSON('/Content/Scripts/Datas/Monitor2.json', function (data) {
...
function SelectItem(identity) {
    ...
    $.getJSON('/Content/Scripts/Datas/Monitor.json', function (res) {
...
function SelectItem2(identity) {
    ...
    $.getJSON('/Content/Scripts/Datas/Monitor2.json', function (res) {
        res.forEach(function (item, i) {
            if (item.identity === identity) {
                var text = [],
                    data = [],
