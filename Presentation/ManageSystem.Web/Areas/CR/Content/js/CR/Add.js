...
function AddProject() {
    ...
    $.ajax({
        ...
        success: function (json) {
            ...
            if (json.status == "true") {
                SuccessWindows("<div style='text-align:center;'>数据保存成功！<br />请<a  style='color:red; background-color: #fffa00;' href='~/Areas/CR/Content/替加环素项目数据采集模板.xlsx'>下载数据模板</a>用于记录实验结果。<br />待实验完成后，再次登录CHINET上传数据。</div>", false, "/CR/CRUpload/Upload");
            } else {
