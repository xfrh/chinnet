...
using ManageSystem.Admin.Validators.Organism;
...
namespace ManageSystem.Admin.Models.Organism
{
    ...
    /// 细菌查询数据模型
    /// </summary>
    [Validator(typeof(BacteriaValidator))]
    public class BacteriaModel : BaseEntityModel
    {
        ...
        /// 细菌分类标识ID
        /// </summary>
        [HtmlDisplayAttribute("细菌分类", "细菌分类标识ID")]
        ...
        /// 细菌标识ID
        /// </summary>
        [HtmlDisplayAttribute("细菌", "细菌标识ID")]
        ...
        /// </summary>
        [HtmlDisplayAttribute("细菌分类", "细菌分类")]
        public IList<SelectListItem> MedicalOrganismTypeList { get; set; }
