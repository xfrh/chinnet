...
{
    [Validator(typeof(SHBarChartTableValidator))]
    public class SHBarChartTableModel : BaseEntityModel
    {
        /// <summary>
        /// 所属数据段
        /// </summary>
        ...
        public List<SHBarChartDataItemTableModel> Antibiotics { get; set; }
    }
}