...
{
    [Validator(typeof(BarChartValidator))]
    public class BarChartModel : BaseEntityModel
    {
        /// <summary>
        /// 所属数据段
        /// </summary>
        ...
        /// 数据项
        /// </summary>
        public List<BarChartDataItemModel> ItemModel { get; set; } = new List<BarChartDataItemModel>();
        ...
        public List<SelectListItem> SatelliteList { get; set; }
    }
}