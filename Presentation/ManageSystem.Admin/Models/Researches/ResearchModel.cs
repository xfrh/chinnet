...
namespace ManageSystem.Admin.Models.Researches
{
	...
	public partial class ResearchModel : BaseEntityModel
	{
		...
		/// 研究名称
		/// <summary>
		[HtmlDisplayAttribute("研究名称","研究名称", true)]
		public String Name { get; set; }

		/// <summary>
		/// 研究编码
		/// <summary>
		[HtmlDisplayAttribute("研究编码","研究编码", true)]
        ...
        /// 科研时间
        /// <summary>
        [HtmlDisplayAttribute("科研时间","科研时间", true)]
		public DateTime StartTime { get; set; }

		/// <summary>
		/// 参与要求
		/// <summary>
		[HtmlDisplayAttribute("参与要求","参与要求",true)]
		public String Require { get; set; }

		/// <summary>
		/// 科研发起人
		/// <summary>
		[HtmlDisplayAttribute("科研发起人","科研发起人", true)]
		public String Author { get; set; }

		/// <summary>
		/// 科研类型id
		/// <summary>
		[HtmlDisplayAttribute("科研类型id","科研类型id", true)]
		...
		/// 研究简介
		/// <summary>
		[HtmlDisplayAttribute("研究简介","研究简介", true)]
